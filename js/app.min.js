...
var cards = [
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td>ET Modelling</td><td>XAI, LSTM</td><td>2024</td><td><a href="#" onclick="modal(event)" data-title="Arter Oy">View</a></td></tr>
